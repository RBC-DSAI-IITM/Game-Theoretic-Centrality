...
public class Main {
    ...
    /**
     * Performs the execution of the MapReduce task Game3.
     *
	...
	public static void main(String[] args) throws Exception {
        ...
        if (args.length != 2) {
            System.err.println("Usage: Game3 <InPath> <OutPath>");
            System.exit(2);
        }
		...
		Job job3 = new Job(conf3, "Game3Phase3");
		...
		Job job4 = new Job(conf4, "Game3Phase4");
