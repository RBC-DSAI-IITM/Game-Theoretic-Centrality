...
public class Main {
  ...
  /**
   * Performs the execution of the MapReduce task Game1.
   *
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length != 2) {
      System.err.println("Usage: Game1 <InPath> <OutPath>");
      System.exit(2);
    }
    ...
    Job job1 = new Job(conf1, "Game1Phase1");
    ...
    Job job2 = new Job(conf2, "Game1Phase2");
